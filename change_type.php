...
<body style="font-size:17px;">
	<form id="form1" name="form1" method="post" action="change_type_process.php">
	<?php
	...
	?>
		...
		<div class="col-md-2">
			<input type="submit" style="margin-bottom:50px;" name="submit" value="ยืนยันการเปลี่ยนแผนการเรียน" class="form-control">
		</div>
		<div class="col-md-2">
